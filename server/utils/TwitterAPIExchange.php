...
class TwitterAPIExchange 
{
     ...
     * @exception If the request fail throw exception.
     */
    public function performRequest($return = true)
    {
        ...
        {	throw new Exception("TwitterAPIExchange::PerformRequest(): Error retrieving the tweets feed, HTTP status code:".$http_status);}
    }
