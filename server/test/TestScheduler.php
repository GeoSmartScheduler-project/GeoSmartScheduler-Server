...
while ($Num_Test < 1)
{
	...
	try {
		...
		$cmd = "php ".$root."/test/bandwidth.php ".escapeshellarg($bandwidthTrace)." > /dev/null 2>/dev/null &";
		shell_exec($cmd);
		//Start test loading test.php
		$response = http_get("http://192.168.1.6/server/test/test.php?trace=".$Num_Test."&gpsFile=".$id_gpsFile,array('time_out'=>8200),$info);
		...
		if ($info["response_code"] == 200) {
			...
			shell_exec("rm /Logs/ServerLog/50k/BWServer".$Num_Test.".log");	
			$Num_Test=$Num_Test-1;
			...
			shell_exec('/home/alberto/adt-bundle-linux/sdk/platform-tools/adb -d shell "run-as com.alberto.GeoSmartScheduler cat /sdcard/database/NetworkMap'.$Num_Test.'.sqlite > /data/data/com.alberto.GeoSmartScheduler/databases/NetworkMap"');
	...
	shell_exec("/home/alberto/adt-bundle-linux/sdk/platform-tools/adb -d pull /sdcard/DOWNLOAD_LOCATION.txt /Logs/DownloadLocLog/TestNaive/100k/dowLoc_log".$Num_Test.".log");
	shell_exec('/home/alberto/adt-bundle-linux/sdk/platform-tools/adb -d shell rm /sdcard/DOWNLOAD_LOCATION.txt');
	
	shell_exec("/home/alberto/adt-bundle-linux/sdk/platform-tools/adb -d pull /sdcard/NOTIFICATIONS.txt /Logs/NotificationsLog/TestNaive/100k/not_log".$Num_Test.".log");
	shell_exec('/home/alberto/adt-bundle-linux/sdk/platform-tools/adb -d shell rm /sdcard/NOTIFICATIONS.txt');
	
	shell_exec("/home/alberto/adt-bundle-linux/sdk/platform-tools/adb -d pull /sdcard/DOWNLOAD_TIME.txt /Logs/DownloadLog/TestNaive/100k/dow_log".$Num_Test.".log");
	shell_exec('/home/alberto/adt-bundle-linux/sdk/platform-tools/adb -d shell rm /sdcard/DOWNLOAD_TIME.txt');
	
	shell_exec("/home/alberto/adt-bundle-linux/sdk/platform-tools/adb -d pull /sdcard/HTTP_THROUGHPUT.txt /Logs/ThroughputLog/TestNaive/100k/throughtput_log".$Num_Test.".log");
	shell_exec('/home/alberto/adt-bundle-linux/sdk/platform-tools/adb -d shell rm /sdcard/HTTP_THROUGHPUT.txt');
	...
	//shell_exec('/home/alberto/adt-bundle-linux/sdk/platform-tools/adb -d pull /sdcard/database/NetworkMap'.$Num_Test.'.sqlite /Logs/DataBase/TestNaive/100k/');
	//Advance test
	$Num_Test++;
