...
shell_exec("/home/alberto/adt-bundle-linux/sdk/platform-tools/adb logcat -d -v raw GSS-Naive-download-location:I *:S >/Logs/DownloadLocLog/Naive/dowLoc_log".$Num_Test.".log");
shell_exec("/home/alberto/adt-bundle-linux/sdk/platform-tools/adb logcat -d -v raw GSS-Naive-notifications:I *:S >/Logs/NotificationsLog/Naive/not_log".$Num_Test.".log");
shell_exec("/home/alberto/adt-bundle-linux/sdk/platform-tools/adb logcat -d -v raw GSS-Naive-download:I *:S >/Logs/DownloadLog/Naive/dow_log".$Num_Test.".log");
